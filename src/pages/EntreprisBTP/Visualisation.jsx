 ...
 const [evenement,setEvenement] = useState([])
  ...
  const fetchPost = async () => {
    try {
      ...
      const doc2 = await getDoc(doc(db, "DemandeServices", id));
        ...
        <div className="lg:col-span-7 col-span-12">
          <Card title="Le projet">
            ...
            <div className="flex-1">
                ...
                <div className="flex-1">
                <Textarea
                   label="Autres a preciser"
                  type="text"
                  placeholder= {data?.autrePrecision}
                 readonly
                />
              ...
              <li className="flex space-x-3 rtl:space-x-reverse">
                <div className="flex-1">
                  ...
                  <Textarea
                   label="Surface hors oeuvre brutes"
                  type="text"
                  placeholder={data?.surfaceHorsOeuvreBrute}
                 readonly
                />
                </div>
              </li>
              <li className="flex space-x-3 rtl:space-x-reverse">
                <div className="flex-1">
                   ...
                   <Textarea
                   label="Emprise de construction"
                  type="text"
                  placeholder={data?.empriseTerrain}
                 readonly
                />
                </div>
              </li> */}
