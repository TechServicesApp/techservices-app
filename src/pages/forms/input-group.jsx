    ...
    <div className="grid xl:grid-cols-2 grid-cols-1 gap-5">
      <Card title="Basic Inputs">
        <div className="space-y-3">
          <InputGroup
            type="text"
            prepend={<Icon icon="heroicons-outline:recherche" />}
          />
          <InputGroup
            type="text"
            append={<Icon icon="heroicons-outline:recherch" />}
          />
          <InputGroup
            type="text"
            append={<Icon icon="heroicons-outline:recherche" />}
            disabled
      ...
      <div className="xl:col-span-2 col-span-1">
        <Card title="Merged">
          <div className="space-y-3">
            <InputGroup
              type="text"
              prependIcon="heroicons-outline:recherche"
              merged
            />
            <InputGroup
              type="text"
              appendIcon="heroicons-outline:recherch"
              merged
            />
            <InputGroup
              type="text"
      ...
      <Card title="Input Groups With Buttons">
        <div className=" space-y-5">
          ...
          <InputGroup
            ...
            prepend={
              <Button
                icon="heroicons-outline:recherche"
                className="btn-outline-dark"
              />
            }
            append={<Button text="Recherche" className="btn-outline-dark" />}
          />
        </div>
      </Card>
