...
import { menuItems } from "@/constant/dataarchitect";
...
const MobileMenuarchitecture = ({ className = "custom-class" }) => {
...
export default MobileMenuarchitecture;
